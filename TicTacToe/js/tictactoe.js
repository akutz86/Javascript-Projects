...
function placeXOrO(squareNumber) {
    ...
    //to see i it contains the square number clicked on 
    if (!selectedSquares.some(element=>element.includes(squareNumber))) {
        ...
        if(activePlayer === 'O') {
            //This fucntion disables clicking for computer choice.
            disableClick();
...
function checkWinConditions() {
    // X 0, 1, 2 condition.
    if     
     (arrayIncludes('0X', '1X', '2X')) { drawWinLine(50,100,558,100)}
    // X 3, 4, 5 condition. 
    ...
    //This fucntion checks is an array includes 3 strings. It is used to check for 
    //each win condition.
...
//placement sound ('./media/place.mp23')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels our animation loop if we've reach the end points.
